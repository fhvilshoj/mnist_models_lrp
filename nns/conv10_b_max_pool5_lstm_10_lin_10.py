...
def get_conv10_b_max_pool5_lstm_10_lin_10_model(x, y_, is_training, *args):
    ...
    for i in range(5):
        with tf.name_scope("conv_{}_1".format(i)):
            output_depth *= 2
        ...
        with tf.name_scope("max_{}".format(i)):
